...
class BFSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BFSK", catch_exceptions=True)
        ...
        # Blocks
        ##################################################
        self._delay_range = Range(0, 100, 1, 75, 200)
        ...
        labels = ['Received Signal', 'Error Signal', 'Transmitted Signal', 'Signal 4', 'Signal 5',
        ...
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_char*1, 77)
        ...
        self.connect((self.blocks_delay_0_0, 0), (self.fec_ber_bf_0, 0))
