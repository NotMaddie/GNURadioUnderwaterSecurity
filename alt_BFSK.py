...
# Title: Alternative BFSK mod/demod
...
class alt_BFSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Alternative BFSK mod/demod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Alternative BFSK mod/demod")
        ...
        self.settings = Qt.QSettings("GNU Radio", "alt_BFSK")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcf(1, firdes.low_pass(1.0, samp_rate, 900, 300), centre, samp_rate)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 129)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 2000, 1, 0, 0)
        ...
        self.connect((self.blocks_sub_xx_1, 0), (self.blocks_multiply_xx_0_0, 0))
...
def main(top_block_cls=alt_BFSK, options=None):
