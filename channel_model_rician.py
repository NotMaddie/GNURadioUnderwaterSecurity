...
class channel_model_rician(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Channel Model Multipath", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Channel Model Multipath")
        ...
        self.settings = Qt.QSettings("GNU Radio", "channel_model_rician")
        ...
        self.samp_rate_2 = samp_rate_2 = 32000
        ...
        self.connect((self.channels_selective_fading_model_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.channels_selective_fading_model_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.channels_selective_fading_model_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=channel_model_rician, options=None):
