...
class impulse_model(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Impulse Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Impulse Noise")
        ...
        self.settings = Qt.QSettings("GNU Radio", "impulse_model")
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_IMPULSE, 1, 0)
...
def main(top_block_cls=impulse_model, options=None):
