...
class channel_model_gaussian(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Gaussian Channel", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Gaussian Channel")
        ...
        self.settings = Qt.QSettings("GNU Radio", "channel_model_gaussian")
        ...
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_auto_correlator_sink_0, 0))
...
def main(top_block_cls=channel_model_gaussian, options=None):
