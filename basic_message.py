...
import basic_message_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class basic_message(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Message Passing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Message Passing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_message")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\notma\\OneDrive\\Desktop\\School\\KNE401 and 402 Honours\\Simulation\\Simulation Own Code\\just in case.txt', False)
...
def main(top_block_cls=basic_message, options=None):
