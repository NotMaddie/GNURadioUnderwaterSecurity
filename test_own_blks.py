...
import test_own_blks_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class test_own_blks(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_own_blks")
...
def main(top_block_cls=test_own_blks, options=None):
